...
This project is indexed by GitNexus as **mobile-e2e-mcp** (3198 symbols, 7368 relationships, 259 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
