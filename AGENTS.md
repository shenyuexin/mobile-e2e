...
This project is indexed by GitNexus as **mobile-e2e-mcp** (4833 symbols, 11057 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
